(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.Abilis = {}));
  ...
  var Navbar = /*#__PURE__*/function () {
    ...
    _createClass(Navbar, [{
      ...
      value: function navbarToggle(navToggle) {
        var navDropClick = function navDropClick(statut, navdrop, dropdown, linked) {
        ...
        navToggle.forEach(function (nav) {
            ...
            if (nav.classList.contains('open')) {
              ...
              navDropdown.forEach(function (navDrop) {
                if (navDrop.classList.contains('click')) {
                  navDropClick('close', navDrop, '.navbar-dropdown-clicked', '.navbar-link');
                } else {
                  navDropClick('close', navDrop, '.navbar-dropdown', '.navbar-link');
                }
              });
            } else {
          ...
          navDropdown.forEach(function (navDrop) {
            var dropClick = function dropClick(navD) {
              if (navD.classList.contains('click')) {
                navDropClick('open', navD, '.navbar-dropdown-clicked', '.navbar-link');
              } else {
                navDropClick('open', navD, '.navbar-dropdown', '.navbar-link');
              }
            };
      ...
      value: function navbarSticky(navbar) {
        if (navbar) {
          ...
          if (stickyType === 'personalized' || stickyType === 'navbar-sticky-fast') {
            stickyType === 'navbar-sticky-fast' && navbar.classList.add(stickyType);
            ...
            var stickyPerso = function stickyPerso() {
              stickyType === 'navbar-sticky-fast' && navbar.classList.toggle('sticky-active', window.scrollY > 0);
            ...
            if (navbar.dataset.path) {
              ...
              if (!isUrlValid) {
                stickyType === 'navbar-sticky-fast' && navbar.classList.add('sticky-active');
      ...
      value: function render() {
        ...
        this.navToggles.forEach(function (navToggle) {
          _this.navbarToggle(document.querySelectorAll(navToggle));
        });
